...
### 3. Events. TOP Tasks* (задача со звёздочкой)

[![Build](https://ci.appveyor.com/api/projects/status/lxljmnxw24m96y2i?svg=true)](https://ci.appveyor.com/project/npeplov/ahj-events-top-tasks)

Environment: https://ci.appveyor.com/project/npeplov/ahj-events-top-tasks
